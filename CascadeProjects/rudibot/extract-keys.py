...
def extract_specific_from_lines():
    ...
    specific_keys = {
        ...
        'Shopify Secret (neu)': '***REDACTED_SHOPIFY_SECRET***',
...
def main():
    ...
    if '***REDACTED_SHOPIFY_SECRET***' in str(all_keys.values()):
        current_secret = current_keys.get('SHOPIFY_CLIENT_SECRET', '')
        if current_secret != '***REDACTED_SHOPIFY_SECRET***':
            updates_needed.append(('SHOPIFY_CLIENT_SECRET', '***REDACTED_SHOPIFY_SECRET***'))
