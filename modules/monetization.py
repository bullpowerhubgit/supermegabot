...
PLANS = {
    ...
    # ── E-Rechnungs-Autopilot Mini-Tool (Stripe live seit 2026-07-16) ────────
    "erechnung_starter": {
        "name": "E-Rechnung Starter",
        "price_eur": 29,
        "stripe_price_id": os.getenv("STRIPE_PRICE_ERECHNUNG_STARTER", "price_1TtvnkRJECiV6vSmvwuuPIMb"),
        "features": ["erechnung_convert", "zugferd_23", "xrechnung_30",
                     "invoices_100_month", "shops_1", "gobd_archive", "email_support"],
        "ai_calls_per_day": 0,
        "shopify_products_limit": 0,
        "support_sla_h": 48,
    },
    "erechnung_pro": {
        "name": "E-Rechnung Pro",
        "price_eur": 79,
        "stripe_price_id": os.getenv("STRIPE_PRICE_ERECHNUNG_PRO", "price_1TtvnqRJECiV6vSmcH9JBeIQ"),
        "features": ["erechnung_convert", "zugferd_23", "xrechnung_30",
                     "invoices_1000_month", "shops_3", "gobd_archive", "api_access",
                     "datev_export", "priority_support_24h"],
        "ai_calls_per_day": 0,
        "shopify_products_limit": 0,
        "support_sla_h": 24,
    },
    "erechnung_business": {
        "name": "E-Rechnung Business",
        "price_eur": 199,
        "stripe_price_id": os.getenv("STRIPE_PRICE_ERECHNUNG_BUSINESS", "price_1Ttw43RJECiV6vSmEcfQoME6"),
        "features": ["erechnung_convert", "zugferd_23", "xrechnung_30",
                     "invoices_unlimited", "shops_unlimited", "gobd_archive", "api_access",
                     "datev_export", "peppol_sending", "white_label", "priority_support_8h"],
        "ai_calls_per_day": 0,
        "shopify_products_limit": 0,
        "support_sla_h": 8,
    },
