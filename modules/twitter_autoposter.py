...
# ── Credentials ──────────────────────────────────────────────────────────────
API_KEY          = os.getenv("TWITTER_API_KEY", "Su5qo1RO007dA75OHziZVOSHJ")
API_SECRET       = os.getenv("TWITTER_API_SECRET", "KHkzYMYoM7jX2AiCPWp2K0VxPgbNTPzqJ9A1yc37WaX2iOIVah")
ACCESS_TOKEN     = os.getenv("TWITTER_ACCESS_TOKEN", "2015131234226102272-9wBVQWHebbncKQhhzTgOIBU3AQpL3Y")
ACCESS_SECRET    = os.getenv("TWITTER_ACCESS_TOKEN_SECRET", "YqsxQp6JYYmC8tvdWWRmqsyb48naGk2W7pwBG0cp2CiVR")
BEARER_TOKEN     = os.getenv("TWITTER_BEARER_TOKEN", "AAAAAAAAAAAAAAAAAAAAAJqK7QEAAAAAJF9M%2F5WtEPm3vgN8luNUAv5GqIA%3DEyQd1lJaGsWWYais0hsxAPhrRUuifTKk4JDqGkqusHxMVBRmSn")
