...
KNOWN_FREE_APIS = [
    ...
    # AI / LLM — alle getestet, alle kostenlos (free-tier oder kein Key)
    ...
    {"name": "Together AI (free $25)", "url": "https://api.together.xyz/v1/models",
     "category": "ai", "auth": True, "docs": "https://docs.together.ai/"},
    {"name": "Fireworks AI (free)", "url": "https://api.fireworks.ai/inference/v1/models",
     "category": "ai", "auth": True, "docs": "https://readme.fireworks.ai/"},
    {"name": "Google Gemini (15 RPM free)", "url": "https://generativelanguage.googleapis.com/v1beta/models",
     "category": "ai", "auth": True, "docs": "https://ai.google.dev/gemini-api/docs"},
    {"name": "Cohere (1k/Monat free)", "url": "https://api.cohere.com/v1/models",
     "category": "ai", "auth": True, "docs": "https://docs.cohere.com/"},
    {"name": "AI21 Labs (free tier)", "url": "https://api.ai21.com/studio/v1/models",
     "category": "ai", "auth": True, "docs": "https://docs.ai21.com/"},
    {"name": "Cerebras (free cloud)", "url": "https://api.cerebras.ai/v1/models",
     "category": "ai", "auth": True, "docs": "https://inference-docs.cerebras.ai/"},
    {"name": "SambaNova (free)", "url": "https://api.sambanova.ai/v1/models",
     "category": "ai", "auth": True, "docs": "https://docs.sambanova.ai/"},
    {"name": "Mistral AI (free tier)", "url": "https://api.mistral.ai/v1/models",
     "category": "ai", "auth": True, "docs": "https://docs.mistral.ai/"},
    {"name": "Pollinations.ai (NO KEY)", "url": "https://text.pollinations.ai/openai/models",
     "category": "ai", "auth": False, "docs": "https://pollinations.ai/"},
    {"name": "Cloudflare Workers AI (10k/Tag free)", "url": "https://api.cloudflare.com/client/v4/accounts/",
     "category": "ai", "auth": True, "docs": "https://developers.cloudflare.com/workers-ai/"},
    {"name": "Lepton AI (free models)", "url": "https://llama3-1-8b.lepton.run/api/v1/models",
     "category": "ai", "auth": True, "docs": "https://www.lepton.ai/docs"},
    {"name": "DeepSeek (free tier)", "url": "https://api.deepseek.com/v1/models",
     "category": "ai", "auth": True, "docs": "https://platform.deepseek.com/api-docs/"},
    # News / Content
